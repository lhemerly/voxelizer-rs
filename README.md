...
``` --crop ```: Crops the voxelization bounding box (the evaluated spatial volume) to 'min_x,min_y,min_z,max_x,max_y,max_z' (e.g., `--crop -10,-10,-10,10,10,10`), rather than cropping the source mesh geometry directly.
