...
struct Args {
    ...
    /// Evaluate and store only the voxels where the absolute distance is within the desired threshold (e.g., --narrow-band 1.0)
    ...
    /// Crops the voxelization bounding box to the given 'min_x,min_y,min_z,max_x,max_y,max_z' (e.g., --crop -10,-10,-10,10,10,10)
