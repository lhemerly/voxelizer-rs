...
struct Args {
    ...
    /// Output will only contain surface voxels instead of solid filling
    #[arg(long)]
    surface_only: bool,
    ...
    /// Crops the voxelization bounding box to the given bounds 'min_x,min_y,min_z,max_x,max_y,max_z'
