...
struct Args {
    ...
    /// Evaluate and store only the voxels where the absolute distance is within the desired threshold (e.g., 1.0)
    ...
    /// Crops the mesh to the given bounding box 'min_x,min_y,min_z,max_x,max_y,max_z' (e.g., -10,-10,-10,10,10,10)
